...
data class ApiGiphyTrending(
    // Always use  @SerializedName to prevent creating bugs when a Kotlin property is renamed.
    // For this demo app I only used it for the top level properties.
    // In a real app I'd use @SerializedName  on all properties.

    // To simplify this demo code I have commented out all of the properties that aren't used.
    @SerializedName("data") val trendingGifs: List<Data>,

    // No "meta" pun intended.
